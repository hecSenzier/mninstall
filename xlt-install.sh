...
CONFIG_FILE='lightexcoin.conf'
CONFIGFOLDER='/root/.lightexcoin'
COIN_DAEMON='/usr/local/bin/lightexcoind'
COIN_CLI='/usr/local/bin/lightexcoin-cli'
COIN_REPO='https://github.com/lightexcoin/release/linux.tar.xz'
COIN_NAME='LightTexCoin'
COIN_PORT=33796
